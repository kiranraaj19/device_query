...
impl fmt::Display for Keycode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Keycode::LControl | Keycode::RControl => write!(f, "⏎"),
            Keycode::LAlt | Keycode::RAlt => write!(f, "⎇"),
            Keycode::Enter => write!(f, "⏎"),
            Keycode::Up | Keycode::PageUp => write!(f, "⇧"),
            Keycode::Down | Keycode::PageDown => write!(f, "⇩"),
            Keycode::Left => write!(f, "⇦"),
            Keycode::Right => write!(f, "⇨"),
            Keycode::Tab => write!(f, "⇥ "),
            Keycode::LShift | Keycode::RShift => write!(f, "⇪"),
            Keycode::Backspace => write!(f, "⌫"),
            Keycode::CapsLock => write!(f, "⤒"),
            Keycode::Insert => write!(f, "⎘"),
            Keycode::Delete => write!(f, "⌧"),
            Keycode::Home => write!(f, "⌂"),
            Keycode::Minus | Keycode::NumpadSubtract => write!(f, "-"),
